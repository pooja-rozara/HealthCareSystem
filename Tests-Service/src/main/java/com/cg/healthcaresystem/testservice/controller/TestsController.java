...
public class TestsController {
	...
	public ResponseEntity<Boolean> removeTest( @RequestBody TestsDTO testsDto) {
		String url = "http://Appointment-service/pendingAppointment?Id=" + testsDto.getTestId();
		ResponseEntity<Boolean> response = restTemplate.getForEntity(url, Boolean.class);
		Boolean appointmentsExists = response.getBody();
		if(appointmentsExists) {
			throw new InvalidArgumentException("Cannot Delete Test. Pending Appointments!");
		}
		else {
